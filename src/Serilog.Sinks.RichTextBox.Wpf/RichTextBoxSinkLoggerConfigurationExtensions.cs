...
namespace Serilog
{
    ...
    public static class RichTextBoxSinkLoggerConfigurationExtensions
    {
        ...
        {
            return RichTextBox(sinkConfiguration, new[] {richTextBoxControl}, restrictedToMinimumLevel, outputTemplate, formatProvider,levelSwitch, theme, dispatcherPriority,syncRoot);
        }
            ...
            object syncRoot = null)
        {
            ...
            var richTextBox = new RichTextBoxImpl(dispatcherPriority, richTextBoxControls);
